...
from card_creator import Card, CardCreator
...
class AnkiDeckInterface:
    ...
    def generate_deck(self, all_cards: Dict[str, List[Card]], deck_name: str, output_dir="./tmp") -> str:
...
if __name__ == "__main__":
    ...
    all_cards = {
        "../mock_data/ppt-to-md.md": cards
    }
    
    deck_creator.generate_deck(all_cards, deck_name="test", output_dir="../mock_data/")